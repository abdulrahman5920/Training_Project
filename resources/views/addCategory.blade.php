...
@section('content')
    ...
    @endif
                                <form method="POST" action="/adminaddcategory"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                                    @csrf
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="add-category">Add Tag <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input name="addcategorybox" type="text" id="add-category" required="required" class="form-control ">
                                        </div>
                                    </div>
