			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="/" class="site_title"><i class="fa fa-file-image-o"></i> <span>Home</span></a>
					</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Tags <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="/admincategory">Add Tag</a></li>
										<li><a href="/admin/showtags">Tags List</a></li>
										<li><a href="/adminitem">Add Item</a></li>
										<li><a href="/admin/editcategory">Edit Category</a></li>
										<li><a href="/admin/edititem">Edit Item</a></li>
									</ul>
								</li>
